...
# --- DEBUGGING: Print session state at the start of the page ---
# This will help us understand if 'logged_in' is carrying over

# You can also print to console for more detailed debugging:
# import sys
# print(f"DEBUG (console): chatbot_ui.py loaded. logged_in={st.session_state.get('logged_in')}, name={st.session_state.get('name')}", file=sys.stderr)
